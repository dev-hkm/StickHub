...
(function () {
  ...
  const translations = {
    vi: {
      ...
      // Hero
      heroBadge: 'Bản Cập Nhật v5.2.34 • Sổ Tay Android Mến Yêu',
      ...
      btnMasterDownload: 'Tải StickHub APK (v5.2.34)',

      // Sticky Bar
      stickySubtitle: 'v5.2.34 • Miễn phí',
    ...
    en: {
      ...
      // Hero
      heroBadge: 'Update v5.2.34 • Cherished Android Scrapbook',
      ...
      btnMasterDownload: 'Download StickHub APK (v5.2.34)',

      // Sticky Bar
      stickySubtitle: 'v5.2.34 • Free',
